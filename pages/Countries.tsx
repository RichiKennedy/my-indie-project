...
const Countries = () => {
  ...
  // const [textColor, setTextColor] = useState("rgb(17 24 39)");

  // useEffect(() => {
  //   const changeColor = () => {
  //     if (inView) {
  //       setColor("rgb(17 24 39)");
  //       setTextColor("rgb(252 231 243)");
  //     } else {
  //       setColor("rgb(252 231 243)");
  //       setTextColor("rgb(17 24 39)");
  //     }
  //   };
  ...
  return (
    <div className="bg-gray-900 text-pink-100">
      <Navbar />
      <HeroCountry />
      <section className=" grid grid-cols-3 justify-center h-[200px] md:h-[300px] lg:h-[400px] p-1 gap-1   ">
      ...
      <ul
        ...
        ref={ref}
        className=" h-[60vh] lg:h-[90vh] flex flex-col ease-in-out duration-300  justify-between items-center px-15 py-20 uppercase text-5xl sm:text-6xl md:text-7xl lg:text-8xl"
      >
