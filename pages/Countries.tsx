...
const Countries = () => {
  ...
  return (
    <div className=" bg-gray-900 text-pink-100">
      <Navbar />
      <HeroCountry />
      <section className=" grid grid-cols-3 justify-center h-[200px] md:h-[300px] lg:[400px] p-5 gap-5 ">
        <div className="relative h-full w-full  ">
          ...
          <Image
            ...
            layout="fill"
            objectFit="cover"
            className="relative hover:scale-105 ease-out duration-150  "
          />
          <h1 className=" cursor-pointer opacity-0 hover:opacity-100 absolute bg-black/40 top-0 right-0 bottom-0 left-0  flex items-center justify-center">
            {" "}
            Bali surf spots
          </h1>
        </div>
